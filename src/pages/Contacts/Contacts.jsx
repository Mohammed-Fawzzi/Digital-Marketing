        ...
        <div className="container py-4">
          <div className="row g-5">
            ...
            <div className="col-md-6">
              <form className="py-5">
                <div>
                  <label htmlFor="name" className="fw-bold h4">
                    Enter Your Full Name
                  </label>
                  <input
                    type="text"
                    id="name"
                    className="form-control w-100 p-3 my-2"
                  />
                </div>

                <div className="py-3">
                  <label htmlFor="email" className="fw-bold h4">
                ...
                <div>
                  <label htmlFor="message" className="fw-bold h4">
                    Write Massage
                  </label>
                  <textarea
                    id="message"
                    className="form-control w-100 py-3 my-3 textarea-custom"
                  />
                </div>
                ...
                <div className="d-flex justify-content-between">
                  <div className="py-3 d-flex align-items-center">
                    ...
                    />
                    <label htmlFor="checkbox" className="fw-bold pt-1">
                      {" "}
                      Save My Email
                    </label>
                  </div>

                  <button className="btn rounded-pill px-5 text-white">
                    Submit
                  </button>
                </div>
              </form>
